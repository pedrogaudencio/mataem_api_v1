...
RSpec.describe Api::V1::CitiesController, type: :controller do
  # TODO: https://stackoverflow.com/questions/24570281/what-to-add-to-rspec-valid-attributes-when-it-is-validating-related-models
  # This should return the minimal set of attributes required to create a valid
  # City. As you add validations to City, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { {name: 'City Name', status: 'active'} }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new city" do
        ...
        expect(response.location).to eq(api_v1_city_path(City.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) { {name: 'New city Name', status: 'active'} }
