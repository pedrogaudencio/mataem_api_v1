...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new advertisement" do

        post :create, params: {advertisement: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(advertisement_url(Advertisement.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new advertisement" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the advertisement" do
        advertisement = Advertisement.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the advertisement" do
        advertisement = Advertisement.create! valid_attributes
